/**
 * AktivitasService.js — CRUD laporan aktivitas harian pegawai (sheet
 * `Aktivitas`): buat/edit draft, finalisasi (kunci + generate PDF resmi),
 * hapus (hanya draft), dan lihat daftar/detail. Semua fungsi client di sini
 * wajib sesi pegawai (role 'pegawai') dan dicek kepemilikan NIP per baris.
 *
 * Kolom sheet Aktivitas (0-indexed): 0 ID Laporan, 1 NIP, 2 Tanggal,
 * 3 Jam Mulai, 4 Jam Selesai, 5 Durasi Menit, 6 Nama Aktivitas, 7 Uraian,
 * 8 Link Foto, 9 Link PDF, 10 Status, 11 Waktu Dibuat, 12 Waktu Diubah,
 * 13 Waktu Finalisasi.
 */
