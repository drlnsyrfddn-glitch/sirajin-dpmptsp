/**
 * AdminService.js — CRUD data admin (sheet `Admin`) untuk SuperAdmin:
 * daftar, tambah/edit (dengan hash password), dan toggle status
 * Aktif/Nonaktif. Semua fungsi di sini wajib sesi admin dengan level
 * SuperAdmin secara spesifik — Admin biasa ditolak (requireAdmin_ dari
 * Auth.js hanya memastikan role === 'admin', tidak memeriksa level).
 *
 * Kolom sheet Admin (0-indexed): 0 ID, 1 NIP, 2 Nama, 3 Password (hash),
 * 4 Level (Admin/SuperAdmin), 5 Status.
 */
